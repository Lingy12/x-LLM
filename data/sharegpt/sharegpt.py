...
class ShareGPT(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [ShareGPTConfig(config=lang, name=f"sharegpt_{lang}") for lang in _LANG]
    ...
    def _split_generators(self, dl_manager):
        print(os.path.join(self.base_path, f"sharegpt_{self.config.lang}.json"))
        return [
            datasets.SplitGenerator(name=datasets.Split.TRAIN, gen_kwargs={"filepath": os.path.join(self.base_path, f"sharegpt_{self.config.lang}.json")}),
        ]
