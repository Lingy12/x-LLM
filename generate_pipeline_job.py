...
def generate_jobs(data_group, dest_dir, gpu_num, home_path, xllm_path, project_name, batch_size, learning_rate, wall_time=24):
    ...
    for data, prompt, base_model in params:
        params = {"ngpu": str(gpu_num), "dataset_conf": str(data), "prompt":str(prompt), 
                  ...
                  "home_path": home_path, "xllm_path": xllm_path, "project_name":project_name, "batch_size": str(batch_size), "learning_rate": str(learning_rate)}
